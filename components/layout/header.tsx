...
export function Header() {
  return (
    <header className="absolute inset-x-0 top-4 z-40 px-4 sm:top-5 sm:px-5">
      <div className="flex w-full items-center justify-between gap-4 px-5 py-4 sm:px-7 sm:py-5 lg:px-10">
        <a
          href="#home"
        ...
        <div className="flex items-center gap-2">
          ...
          <details className="relative lg:hidden">
            ...
            <div className="absolute right-0 top-[calc(100%+0.75rem)] w-56 rounded-[24px] border border-white/12 bg-[#091b52]/96 p-4 text-white shadow-[0_20px_60px_rgba(3,10,35,0.32)] backdrop-blur-md">
